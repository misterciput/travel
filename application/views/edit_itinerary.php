<form class="col s12" action="<?=base_url()?>paket/do_edit_itinerary" method="post" enctype="multipart/form-data">
  <div class="row">
...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
  <a class="btn-floating btn-large waves-effect waves-light orange" href="<?=base_url()?>paket/edit/<?=$id_paket?>">
